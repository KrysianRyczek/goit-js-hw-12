            ...
            <div class="box">
                ...
                <div class="box-item">
                    ...
                    <p id="downloads">${p}</p>
                                                ...
                                                </div>`)},N=async e=>(await f.get(e.addres)).data,L=new b("ul.gallery>li>a",{captions:!0,captionType:"attr",captionsData:"alt",captionPosition:"bottom",captionDelay:250,overlay:!0});let o,r,l,c;window.addEventListener("click",e=>{if(e.target.id==="submit"||e.target.id==="btnNext"){if(e.preventDefault(),e.target.id==="submit"&s.querySelector("#img").value.trim()===""){document.querySelector("#mesage")===null&&s.insertAdjacentHTML("afterend",'<p id="mesage" class="message">Form field must be filled in!</p>');return}if(e.target.id==="submit"&&(o=1,r=new x(s.querySelector("#img").value.trim(),o),document.querySelector("#gallery").hasChildNodes()&&document.querySelectorAll("#gallery > li").forEach(i=>i.remove()),document.querySelector("#btnNext")!==null&&document.querySelector("#btnNext").remove()),document.querySelector("#mesage")!==null&&document.querySelector("#mesage").remove(),e.target.id==="btnNext"&&(o=o+1,r.pageNumber=o,document.querySelectorAll("#gallery>li").length+r.limit>r.hits))return document.querySelector("#btnNext").remove(),d.warning({close:!1,position:"topCenter",progressBar:!1,backgroundColor:"lightblue",messageColor:"white",timeout:5e3,message:"Sorry, there are no images matching your search query. Please try again!",transitionOut:"fadeOutUp"});const t=document.querySelector("#loader");t.classList.add("loader"),e.target.id==="btnNext"&&(l=document.querySelector("#btnNext"),c=l.getBoundingClientRect().y-40),N(r).then(a=>{if(t.classList.remove("loader"),a.total===0)return d.error({close:!1,position:"topCenter",progressBar:!1,backgroundColor:"red",messageColor:"white",timeout:5e3,message:"Sorry, there are no images matching your search query. Please try again!",transitionOut:"fadeOutUp"});v("ul.gallery",a.hits),L.refresh(),document.querySelector("#btnNext")==null&&w("ul.gallery"),e.target.id==="submit"&&(s.reset(),r.maxHits=a.totalHits,l=document.querySelector("#gallery"),c=l.getBoundingClientRect().y-20),window.scrollBy({top:c,behavior:"smooth"})}).catch(a=>{t.classList.remove("loader"),console.log(a)})}});
//# sourceMappingURL=search-image-0217b44e.js.map
